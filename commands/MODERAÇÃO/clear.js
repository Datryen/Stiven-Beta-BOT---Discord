module.exports = {
  ...
  aliases: ['apagar'],
  code:`
<:emoji_5:843677319113342987> **|** O chat teve $message mensagens deletadas por <@$authorID>.
$clear[$message[1]]
$deleteIn[12s]

$onlyIf[$message[1]<=100;<:emoji_18:845090542605828136> **|** <@$authorID> eu só posso apagar até \`100\` mensagens por vez!]
